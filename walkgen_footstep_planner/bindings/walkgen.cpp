...
template <class Copyable> bp::object generic__copy__(bp::object copyable) {
...
struct FootTrajectoryBezierPythonVisitor
  ...
  void visit(PyClassFootTrajectoryBezier &cl) const {
    cl.def(bp::init<>(bp::arg(""), "Default constructor."))
        .def("evaluateBezier", &FootTrajectoryBezier::evaluateBezier,
             bp::args("indice", "t"), "Evaluate Bezier curve.\n")
        .def("evaluatePoly", &FootTrajectoryBezier::evaluatePoly,
             bp::args("indice", "t"), "Evaluate polynomial reference curve.\n")
        .def("initialize", &FootTrajectoryBezier::initialize,
             "Initialize Bezier curves from Python.\n")
        .def("set_parameters_up", &FootTrajectoryBezier::set_parameters_up,
             "Set hyperparameters for going up.")
        .def("set_parameters_down", &FootTrajectoryBezier::set_parameters_down,
             "Set hyperparameters for going down.")
        .def("getT0", &FootTrajectoryBezier::getT0,
             "Get the T_min argument of the curve.\n")
        .def("getCoefficients", &FootTrajectoryBezier::getCoefficients,
        ...
        .def("update", &FootTrajectoryBezier::update,
             "Optimises the coefficients of the Bezier curve.\n");
  }
...
void exposeBezierWrapper() {
  ...
  bp::class_<FootTrajectoryWrapper>(
      ...
      bp::init<double, int, double, pinocchio::SE3, pinocchio::SE3,
               bp::optional<Params>>(
          bp::args("dt", "N", "step_height", "M_current", "M_next"),
      ...
      .def("update", &FootTrajectoryWrapper::update,
           bp::args("x0", "v0", "xf", "t0", "init_surface", "end_surface"))
      ...
      .def("get_curve", &FootTrajectoryWrapper::get_curve,
...
void exposeQuadrupedalGait() {
  ...
  walkgen::python::StdMapPythonVisitor<
      typename StdMap_string_SE3::key_type,
      typename StdMap_string_SE3::mapped_type,
  ...
  walkgen::python::StdVectorPythonVisitor<
      ...
      typename StdVec_Map_string_SE3::allocator_type>::
      expose("StdVec_Map_string_SE3");

  bp::class_<QuadrupedalGaitGenerator>(
      "QuadrupedalGaitGenerator",
      bp::init<double, int, std::string, std::string, std::string, std::string>(
          (bp::arg("dt") = 0.01, bp::arg("S") = 4, bp::arg("lf") = "LF_FOOT",
           bp::arg("lh") = "LH_FOOT", bp::arg("rf") = "RF_FOOT",
           bp::arg("rh") = "RH_FOOT")))
      .def("walk", &QuadrupedalGaitGenerator::walk,
           (bp::arg("contacts"), bp::arg("N_ds"), bp::arg("N_ss"),
            bp::arg("N_uds") = 0, bp::arg("N_uss") = 0,
            bp::arg("stepHeight") = 0.15, bp::arg("startPhase") = true,
            bp::arg("endPhase") = true))
...
struct SurfacePythonVisitor
    : public bp::def_visitor<SurfacePythonVisitor<Surface>> {
  template <class PyClassSurface> void visit(PyClassSurface &cl) const {
    cl.def(bp::init<>(bp::arg(""), "Default constructor."))
        ...
        .def("getHeight", &Surface::getHeight, bp::args("point"),
  ...
  static void expose() {
    bp::class_<Surface>("Surface", bp::no_init)
        .def(SurfacePythonVisitor<Surface>());
...
void exposeParams() {
  bp::class_<Params, boost::noncopyable>(
      ...
      bp::init<bp::optional<std::string>>(
          bp::args("filename"), "Constructor for parameter to laod the yaml."))
      ...
      .def_readwrite("N_uds", &Params::N_uds,
      ...
      .def_readwrite("t_margin_up", &Params::t_margin_up,
                     "Time margin for the Bezier curves")
      .def_readwrite("z_margin_up", &Params::z_margin_up,
                     "Height margin for the Bezier curves")
      .def_readwrite("margin_down", &Params::margin_down,
                     "Margin for the Bezier curves")
      .def_readwrite("t_margin_down", &Params::t_margin_down,
                     "Time margin for the Bezier curves")
      .def_readwrite("z_margin_down", &Params::z_margin_down,
                     "Height margin for the Bezier curves")
      .def_readwrite("N_sample", &Params::N_sample,
                     "Number of samples for the Bezier curves")
      .def_readwrite("N_sample_ineq", &Params::N_sample_ineq,
                     "Number of samples for the inequality constraints")
...
void exposeContactPhase() {
  ...
  bp::class_<ContactPhase, boost::noncopyable>(
      "ContactPhase",
      bp::init<int, bp::optional<ContactType>>(
          bp::args("T", "contactType"),
          "Constructor for a ContactPhase object without a trajectory."))
      .def(bp::init<int, ContactType, std::shared_ptr<FootTrajectoryWrapper>>(
          bp::args("T", "contactType", "trajectory"),
          "Constructor for a ContactPhase object."))
      .def(bp::init<int, std::shared_ptr<FootTrajectoryWrapper>>(
          bp::args("T", "trajectory"),
          "Constructor for a ContactPhase object."))
      .add_property(
          "trajectory",
          bp::make_function(&ContactPhase::getTrajectory,
                            bp::return_value_policy<bp::return_by_value>()),
          &ContactPhase::setTrajectory, "Trajectory in the ContactPhase.")
      .def_readwrite("T", &ContactPhase::T_,
                     "Number of nodes in the ContactPhase.")
      .def_readwrite("contactType", &ContactPhase::contactType_,
                     "Number of nodes in the ContactPhase.")
      .def("__add__", &ContactPhase::operator+,
           bp::return_value_policy<bp::return_by_value>())
...
void exposeContactSchedule() {
  ...
  walkgen::python::StdVectorPythonVisitor<
      ContactPhasePtr,
      std::allocator<ContactPhasePtr>>::expose("StdVec_ContactPhaseVec");
  walkgen::python::StdVectorPythonVisitor<
      ContactPhaseVecPtr,
  ...
  bp::class_<ContactSchedule, boost::noncopyable>(
      "ContactSchedule", bp::init<double, int, int, std::vector<std::string>>(
                             bp::args("dt", "T", "S_total", "contactNames"),
...
struct overload_CoeffBezier
  ...
  template <class Class> void visit(Class &cl) const {
    cl.def("__getitem__", &overload_CoeffBezier::base_get_item,
           bp::return_value_policy<bp::return_by_value>());
  }
...
void exposeGaitManager() {
  ...
  walkgen::python::StdVectorPythonVisitor<
      ...
      std::allocator<std::shared_ptr<ContactSchedule>>>::
      expose("StdVec_ContactSchedule");

  // CoeffBEzier indexing, CoeffBezier[0] --> t0, CoeffBezier[1] --> coeffs
  overload_CoeffBezier visitor = overload_CoeffBezier();

  bp::class_<CoeffBezier>(
      "CoeffBezier_tuple",
      bp::init<double, Eigen::MatrixXd>(
          bp::args("t0", "coeffs"),
          "Constructor for tuple like class CoeffBezier_tuple"))
      .add_property("t0", bp::make_function(
                              &CoeffBezier::get_t0,
                              bp::return_value_policy<bp::return_by_value>()))
      .add_property(
          "coeffs",
          bp::make_function(&CoeffBezier::get_coeffs,
                            bp::return_value_policy<bp::return_by_value>()))
  ...
  walkgen::python::StdVectorPythonVisitor<
      CoeffBezier, std::allocator<CoeffBezier>>::expose("StdVec_CoeffBezier");
  typedef std::vector<CoeffBezier> StdVec_CoeffBezier;
  walkgen::python::StdVectorPythonVisitor<
      StdVec_CoeffBezier,
      std::allocator<StdVec_CoeffBezier>>::expose("StdVecVec_CoeffBezier");
  typedef std::vector<StdVec_CoeffBezier> StdVecVec_CoeffBezier;
  walkgen::python::StdVectorPythonVisitor<
      StdVecVec_CoeffBezier, std::allocator<StdVecVec_CoeffBezier>>::
      expose("StdVecVecVec_CoeffBezier");

  bp::class_<GaitManager>(
      "GaitManager",
      bp::init<pinocchio::Model, VectorN, bp::optional<Params>>(
      ...
      .def("get_cs", &GaitManager::get_cs,
           bp::return_value_policy<bp::return_by_value>())
      .add_property(
          "_timeline",
          bp::make_function(&GaitManager::get_timeline,
                            bp::return_value_policy<bp::return_by_value>()))
...
void exposeFilter() {
  bp::class_<FilterMean, boost::noncopyable>(
      "FilterMean", bp::init<double, double>(bp::args("period", "dt"),
                                             "Constructor for Moving filter."))
...
void exposeFootStepPlanner() {
  ...
  walkgen::python::StdVectorPythonVisitor<
      Surface, std::allocator<Surface>>::expose("StdVec_Surface");
  walkgen::python::StdMapPythonVisitor<
      std::string, Surface, std::less<std::string>,
      std::allocator<std::pair<const std::string, Surface>>>::
      expose("StdMap_string_Surface");
  walkgen::python::StdMapPythonVisitor<
      std::string, StdVec_Surface, std::less<std::string>,
      std::allocator<std::pair<const std::string, StdVec_Surface>>>::
      expose("StdMap_string_VecSurface");
  bp::class_<FootStepPlanner, boost::noncopyable>(
      "FootStepPlanner", bp::init<pinocchio::Model, VectorN, Params, double>(
                             (bp::args("model"), bp::args("q"),
                              bp::args("params"), bp::args("period") = 0.5)))
      .def(bp::init<pinocchio::Model, Eigen::VectorXd, double>(
          (bp::args("model"), bp::args("q"), bp::args("period") = 0.5)))
      .add_property("q_f", bp::make_function(
                               &FootStepPlanner::get_qf,
                               bp::return_value_policy<bp::return_by_value>()))
      .add_property("qv_f", bp::make_function(
                                &FootStepPlanner::get_qvf,
                                bp::return_value_policy<bp::return_by_value>()))
      .add_property(
          "_contact_names_SL1M",
          bp::make_function(&FootStepPlanner::get_contact_name_sl1m,
                            bp::return_value_policy<bp::return_by_value>()))
      .add_property(
          "_contactNames",
          bp::make_function(&FootStepPlanner::get_contact_name,
                            bp::return_value_policy<bp::return_by_value>()))
      .add_property(
          "_current_position",
          bp::make_function(&FootStepPlanner::get_current_position,
                            bp::return_value_policy<bp::return_by_value>()))
