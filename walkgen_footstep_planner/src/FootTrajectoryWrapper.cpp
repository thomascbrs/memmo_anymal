...
MatrixN FootTrajectoryWrapper::get_coefficients() { return curve_->getCoefficients(); }

std::shared_ptr<FootTrajectoryBezier> FootTrajectoryWrapper::get_curve() { return curve_; }
