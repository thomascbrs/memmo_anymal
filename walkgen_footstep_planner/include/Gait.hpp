...
// typedef std::map<std::string, pinocchio::SE3, std::less<std::string>, std::allocator<std::pair<const std::string,pinocchio::SE3>> > StdMap_string_SE3;
...
public:
    ...
    std::shared_ptr<ContactSchedule> trot(StdVec_Map_string_SE3 contacts, int N_ds, int N_ss, int N_uds, int N_uss, double stepHeight, bool startPhase, bool endPhase);
